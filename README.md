...
```text
[Done]Set up "empty" reducer and initial state 👉 [Done]Set up store and Provider 👉
[Done]Connect components 👉 Add events and event handlers in UI 👉 Build action creators 👉
